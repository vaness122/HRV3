            ...
            <div className="col-span-4 sm:col-span-3">
              <div className="bg-white shadow rounded-lg p-6">
                <div className="flex flex-col items-center">
                  <img src="" alt="profile picture" className="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0" />
                  <h1 className="text-xl font-bold">{employee.firstName} {employee.middleName} {employee.lastName}</h1>
                  <p className="text-gray-700">{employee.age} years old, {employee.gender}</p>
            ...
            <div className="col-span-4 sm:col-span-9">
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="flex justify-center items-center gap-6 my-6">
                  <a href="#" target="_blank" className="text-gray-700 hover:text-orange-600" aria-label="Visit profile on LinkedIn">
                  ...
                  <a href="#" target="_blank" className="text-gray-700 hover:text-orange-600" aria-label="Visit profile on YouTube">
                  ...
                  <a href="#" target="_blank" className="text-gray-700 hover:text-orange-600" aria-label="Visit profile on Facebook">
                  ...
                  <a href="#" target="_blank" className="text-gray-700 hover:text-orange-600" aria-label="Visit profile on Instagram">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-6">
                      <path fill="currentColor"
                  ...
                  <a href="#" target="_blank" className="text-gray-700 hover:text-orange-600" aria-label="Visit profile on Twitter">
                ...
                <div className="mb-6">
                  <div className="flex justify-between flex-wrap gap-2 w-full">
                    ...
                    <p>
                      <span className="text-gray-700 mr-2">at Company</span>
